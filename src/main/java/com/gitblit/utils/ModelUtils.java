...
public class ModelUtils {
	 ...
	 * @param username
	 *            name of user
	 * @return the active user repository project prefix concatenated with the
	 *         user name
	 */
	 ...
	 * @return true, if the name starts with the active user repository project
	...
	/**
	 * Test if a repository path is for a personal repository of a specific
	 * user.
	 *
	 * @param username
	 *            Name of a user
	 ...
	 * @param path
	 *            A project name, a relative path to a repository.
	 * @return If the path does not point to a personal repository, an empty
	 *         string is returned. Otherwise the name of the user the personal
	 *         repository belongs to is returned.
	 */
